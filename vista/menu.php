<body>
  <nav class="navbar navbar-expand-lg " style="background-color: #284078;">
    <div class="container-fluid align-self-center">
      <a class="navbar-brand d-block text-light " href="index.php">
      ...
      <div class="collapse navbar-collapse position-absolute end-0" id=" navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0 pull-xs-left">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
              <li><a class="dropdown-item menu-contable" href="cuentas.php">Ingresar Cuenta</a></li>
              <li><a class="dropdown-item menu-contable" href="tabla_valores.php">Descargar</a></li>
            </ul>
          </li>
