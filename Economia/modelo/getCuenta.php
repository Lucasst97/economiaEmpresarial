...
$queryC = "SELECT `cod_cuenta`, nombre_cuenta FROM cuenta WHERE
 cod_rubro = '$cod_rubro' and cod_bloque= '$cod_bloque' and cod_grupo= '$cod_grupo' ";
...
while ($rowC = mysqli_fetch_assoc($rsC)) {
    ...
    $html .= "<tr><td>".$cod_cuenta."</td><td>" . $rowC['nombre_cuenta'] . 
    "</td><td><input type='button' class='matricularBtn' name='boton' id='boton' 
    onclick='Cuenta($cod_grupo, $cod_bloque, $cod_rubro, $cod_cuenta)' 
    value='Modificar'></td><td><input type='button' class='matricularBtn' 
    name='boton' id='boton' onclick='Cuenta($cod_grupo, $cod_bloque, $cod_rubro, $cod_cuenta)' value='Eliminar'></td></tr>";
}
