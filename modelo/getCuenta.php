...
$queryC = "SELECT `cod_cuenta`, nombre_cuenta, saldo_cuenta FROM cuenta WHERE cod_rubro = '$cod_rubro' and cod_bloque= '$cod_bloque' and cod_grupo= '$cod_grupo' ";
